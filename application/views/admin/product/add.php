...
$(document).ready(function(){
    $('#category').change(function(){
       ...
       $.post("getSubCategory",{id:$(this).val(),'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'},function(data){
    ...
    $('#save_product').click(function(){
        ...
        if(error>0){
            ...
            $('.price_main_div').show();
             $('.success_msg').html('Data is Successfully Added');
                $('#successModal').modal('show');
    ...
    $('#price_add').click(function(){
        ...
        if(error>0){
            ...
            $('.price-error').hide();
            var product_id=$('#product_id').val();
            $.post("saveProductPrice",{  product_id:product_id,
    ...
    $('#field_add').click(function(){
        ...
        if(error==1){
            ...
            var product_id=$('#product_id').val();
            $.post("saveProductField",{  product_id:product_id,
...
<div class="row">
    ...
    <div class="col-lg-12">
        <h2 class="page-header">New Product  <a href="<?php echo base_url()?>index.php/manageproduct/new" class="btn btn-info pull-right">Add New Product</a></h2>
    </div>
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-md-4">
                                <button type="button" class="btn btn-primary" id="save_product"><i class="fa fa-plus" aria-hidden="true" ></i> Save Product</button>
    ...
    <div class="row price_main_div" style="display:none">
        <div class="col-md-12 zero-margin">
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
    ...
    <div class="row field_main_div" style="display:none">
        <div class="col-md-12 zero-margin">
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
    ...
    <div class="row image_main_div" style="display:none" >
        <div class="col-md-12 zero-margin">
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                                            ...
                                            <tr>
                                                ...
                                                <td width="65%">
                                                    <select class="form-control"  id="field_title_add">
                                                       ...
                                                       <?php
                                                         $record = $this->db->query("SELECT * FROM `tbl_field_master` where status='ACTIVE'")->result();
                                                         foreach($record as $row){
                                                       ?>
