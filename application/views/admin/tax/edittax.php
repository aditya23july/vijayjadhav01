...
<div class="row">
    ...
    <?php echo form_open_multipart('managetax/edit/'.$id,array('role'=>'form','id'=>'category_create')) ?>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-md-4">
                                <input type="text" class="form-control" name="name" id="name" value='<?php echo $data->title;?>'>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 col-md-2 right-padding">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-md-4">
                                <input type="text" class="form-control" name="taxvalue" id="taxvalue"  value='<?php echo $data->tax_value;?>'>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 col-md-2 right-padding">
