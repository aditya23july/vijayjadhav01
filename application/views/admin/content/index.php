                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id ="table">
                                    <tr class="bg-gray">
                                        ...
                                        <th width="18%">Title <i class="fa fa-sort" aria-hidden="true"></i></th>
                                    ...
                                    <?php
                                     $record=$this->db->query('select * from tbl_content_management')->result();
                                     $i=1;
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo Date('d-M-Y H:i:s',strtotime($row->created_date)); ?></td>
                                        <td>
                                            ...
                                            ?>
                                            <a class="btn btn-primary" href="<?php echo base_url()?>index.php/managecontent/update/<?php echo $encrypted_string?>">
                                            Edit
                                            </a>
                                        </td>
