                    	...
                    	<div class="col-md-12 zero-margin">
                            <div class="row  page-head">
                                <div class="col-md-6 zero-margin left-padding">
                                    <h1 class="">Manage Category <span class="pull-right search-span"></h1>
                                </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id ="table">
                                    <tr class="bg-gray">
                                        ...
                                        <th width="18%">Category Name <i class="fa fa-sort" aria-hidden="true"></i></th>
                                        <th width="17%">Parent Category <i class="fa fa-sort" aria-hidden="true"></i></th>
                                    ...
                                    <?php
                                     $record=$this->db->query('select * from tbl_category_master')->result();
                                     $i=1;
                                     foreach($record as $row){
        
                                         $parentrecord=$this->db->query("select * from tbl_category_master where category_id='$row->parent_category_id'")->row();
                                    ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        ...
                                        <td>
                                            <?php 
                                            if(isset($parentrecord->category_name)){
                                            echo ucfirst($parentrecord->category_name); 
                                            }else{
                                                echo 'None';
                                            }
                                            ?>
                                       ...
                                       <td><?php echo Date('d-M-Y H:i:s',strtotime($row->created_date)); ?></td>
                                        <td>
                                            <?php 
                                            $encrypted_string = $this->encrypt->encode($row->category_id);
                                            $find=array("+","-","/","=");
                                            $replace=array("__ADD__","__DASH__","__SLASH__","__EQUAL__");
                                            $encrypted_string=str_replace($find,$replace,$encrypted_string);
                                            ?>
                                            <a class="btn btn-primary" href="<?php echo base_url()?>index.php/managecategory/update/<?php echo $encrypted_string?>">
                                            Edit
                                            </a>
                                        </td>
